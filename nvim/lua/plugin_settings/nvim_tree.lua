...
vim.cmd('highlight! link NvimTreeFolderIcon Conditional')
vim.cmd('highlight! link CursorLineNr Conditional')
vim.cmd('highlight! link LineNr Conditional')
vim.cmd('highlight! link CursorLine Conditional')
vim.cmd('highlight! link StatusLine Conditional')
vim.cmd('highlight! link StatusLineNC Conditional')
vim.cmd('highlight! link IndentMarker Conditional')
vim.cmd('highlight! link FolderIcon Conditional')

vim.cmd [[ highlight Directory guifg=#8094b4 gui=bold ]]
vim.cmd [[ highlight NvimTreeClosedFolderIcon guifg=#8094b4 gui=bold ]]
