...
vim.keymap.set('n', ')', function() navigate_hunk('next') end, { noremap = true, silent = true, desc = "Next git hunk" })
vim.keymap.set('n', '(', function() navigate_hunk('prev') end, { noremap = true, silent = true, desc = "Previous git hunk" })
