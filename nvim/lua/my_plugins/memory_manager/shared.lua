-- Shared config + mutable state for memory_manager submodules. Kept in a
-- standalone module so stats/prune/rpc/dashboard can require it without
-- creating a cycle through init.lua.
...
-- ============================================================================
-- Config (mutate via require("my_plugins.memory_manager").config.<key>)
-- ============================================================================
...
-- Dashboard state survives close+reopen within one nvim session.
M.dashboard_state = {
  sort = "size", folded = {},
