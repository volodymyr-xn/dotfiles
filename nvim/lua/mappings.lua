...
vim.api.nvim_set_keymap('n', '<Leader>\'', 'cs"\'', { noremap = true })
...
-- Yank, comment and paste (useful for refactoring)
vim.api.nvim_set_keymap('v', 'M', 'yV\']:<C-u>TComment<CR>\']pj', {noremap = true})
vim.api.nvim_set_keymap('n', 'M', 'yy\']:<C-u>TComment<CR>\']pj', {noremap = true})
