...
function M.setup_highlights()
  vim.api.nvim_set_hl(0, "OneDiffLineAdd", { bg = "#2d4a3e", default = true })
  vim.api.nvim_set_hl(0, "OneDiffLineDelete", { bg = "#4a2d2d", default = true })
  vim.api.nvim_set_hl(0, "OneDiffCharAdd", { bg = "#3d6a5e", fg = "#a6e3a1", bold = true, default = true })
  vim.api.nvim_set_hl(0, "OneDiffCharDelete", { bg = "#6a3d3d", fg = "#f38ba8", bold = true, default = true })
